                    ...
                    <div className="space-y-4">
                        {RESUME_DATA.work.map((work) => (
                            ...
                            >
                                ...
                                <h4 className="mt-7 font-semibold  leading-none print:text-[12px]">
                                    {work.title}
                                </h4>
                                {work.points && (
                                        ...
                                        {work.points.map((point, index) => {
                                            if (typeof point === "string") {
                                                return (
                                                    <li
                                                        key={index}
                                                        className="ml-5 text-muted-foreground"
                                                    >
                                                        {point}
                                                    </li>
                                                );
                                                    ...
                                                    <D.Dialog key={point.slug}>
                                                        ...
                                                        <D.DialogContent className="gap-0 px-0 pb-3">
                                                            ...
                                                            <div className="mt-1 text-center text-sm text-gray-500">
                                                                {
                                                                    project.startMonthString
                                                                }{" "}
                                                                -{" "}
                                                                {
                                                                    project.endMonthString
                                                                }
                                                            </div>
