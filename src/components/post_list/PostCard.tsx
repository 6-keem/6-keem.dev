				...
				>
					...
					<div className="w-full flex flex-col justify-between overflow-hidden">
						<div className="flex-1">
							<h2 className="mb-3 text-lg font-semibold sm:text-lg md:text-xl">{post.title}</h2>
							{/* TODO 추후에 정확한 계산 필요 */}
							<div
						...
						<div className="flex justify-between gap-3 text-sm text-gray-500 dark:text-gray-400">
							...
							<div className="text-sm font-medium text-sky-500 lg:text-base">{post.categoryPublicName}</div>
						</div>
					</div>
				</li>
			</Link>
